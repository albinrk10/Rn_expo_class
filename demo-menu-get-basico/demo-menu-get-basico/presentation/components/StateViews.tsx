...
export function LoadingView() {
    return (
        <View className="items-center rounded-2xl bg-white p-6">
            ...
            <Text className="mt-3 font-bold text-slate-600">Cargando...</Text>
        </View>
    );
}
...
export function ErrorView({ mensaje, onReintentar }: ErrorViewProps) {
    return (
        <View className="items-center rounded-2xl bg-rose-50 p-6">
            ...
            <Text className="mt-3 text-center font-bold text-rose-700">
                {mensaje}</Text>
            <TouchableOpacity className="mt-4 rounded-xl bg-rose-600 px-5 py-3" 
